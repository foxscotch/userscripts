...
if (window.location.search.startsWith('?action=pm')) {
    images = images.concat(Array.prototype.slice.call(document.querySelectorAll('.personalmessage img')));
    if (includeSignatures) {
        images = images.concat(Array.prototype.slice.call(document.querySelectorAll('.signature img')));
    }
}
else if (window.location.search.startsWith('?topic=')) {
    images = images.concat(Array.prototype.slice.call(document.querySelectorAll('.post img')));
}
